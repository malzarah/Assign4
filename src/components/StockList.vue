                ...
                >
                  <v-card>
                    ...
                    <v-list v-show="isExpanded(item)" dense>
                      ...
                      <v-list-item>
                        <v-list-item-content>Purchase_price:</v-list-item-content>
                        <v-list-item-content class="align-end">{{ item.purchase_price }} </v-list-item-content>
                      </v-list-item>
                      <v-list-item>
                        <v-list-item-content>Purchase_date</v-list-item-content>
                        <v-list-item-content class="align-end">{{ item.purchase_date }} </v-list-item-content>
                      </v-list-item>
                    </v-list>
                  </v-card>
                </v-col>
